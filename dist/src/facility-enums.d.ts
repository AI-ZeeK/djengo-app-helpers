...
export declare enum FACILITY_MODE_ENUM {
...
export declare enum BED_TYPE_ENUM {
    STANDARD = "standard",
    ICU = "icu",
    MATERNITY = "maternity",
    PEDIATRIC = "pediatric",
...
export declare enum ROOM_CLASS_ENUM {
    SINGLE = "single",
    DOUBLE = "double",
    TWIN = "twin",
    SUITE = "suite",
...
export declare enum TABLE_SHAPE_ENUM {
    ROUND = "round",
    SQUARE = "square",
...
export declare enum UNIT_TYPE_ENUM {
    APARTMENT = "apartment",
    TOWNHOUSE = "townhouse",
    PENTHOUSE = "penthouse",
    STUDIO = "studio",
...
export declare enum SECTION_CLASS_ENUM {
    WARD_BAY = "ward_bay",
    DINING = "dining",
    PARKING = "parking",
    RETAIL = "retail",
...
export declare enum OCCUPANT_CONTACT_ROLE_ENUM {
    PRIMARY = "primary",
...
//# sourceMappingURL=facility-enums.d.ts.map