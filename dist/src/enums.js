...
(function (CALENDAR_RECURRENCE_PRESET_ENUM) {
    CALENDAR_RECURRENCE_PRESET_ENUM[CALENDAR_RECURRENCE_PRESET_ENUM["RECURRENCE_NONE"] = 0] = "RECURRENCE_NONE";
    CALENDAR_RECURRENCE_PRESET_ENUM[CALENDAR_RECURRENCE_PRESET_ENUM["RECURRENCE_DAILY"] = 1] = "RECURRENCE_DAILY";
    CALENDAR_RECURRENCE_PRESET_ENUM[CALENDAR_RECURRENCE_PRESET_ENUM["RECURRENCE_WEEKLY_SAME_WEEKDAY"] = 2] = "RECURRENCE_WEEKLY_SAME_WEEKDAY";
    CALENDAR_RECURRENCE_PRESET_ENUM[CALENDAR_RECURRENCE_PRESET_ENUM["RECURRENCE_MONTHLY_SAME_MONTHDAY"] = 3] = "RECURRENCE_MONTHLY_SAME_MONTHDAY";
    CALENDAR_RECURRENCE_PRESET_ENUM[CALENDAR_RECURRENCE_PRESET_ENUM["RECURRENCE_MONTHLY_NTH_WEEKDAY"] = 4] = "RECURRENCE_MONTHLY_NTH_WEEKDAY";
})(CALENDAR_RECURRENCE_PRESET_ENUM || (exports.CALENDAR_RECURRENCE_PRESET_ENUM = CALENDAR_RECURRENCE_PRESET_ENUM = {}));
var CALENDAR_EVENT_TYPE_ENUM;
(function (CALENDAR_EVENT_TYPE_ENUM) {
    CALENDAR_EVENT_TYPE_ENUM["MEETING"] = "MEETING";
    CALENDAR_EVENT_TYPE_ENUM["TASK"] = "TASK";
    CALENDAR_EVENT_TYPE_ENUM["SHIFT"] = "SHIFT";
    ...
    CALENDAR_EVENT_TYPE_ENUM["ORDER_CREATED"] = "ORDER_CREATED";
    CALENDAR_EVENT_TYPE_ENUM["ORDER_UPDATED"] = "ORDER_UPDATED";
    CALENDAR_EVENT_TYPE_ENUM["ORDER_COMPLETED"] = "ORDER_COMPLETED";
    CALENDAR_EVENT_TYPE_ENUM["PAYMENT_RECEIVED"] = "PAYMENT_RECEIVED";
    CALENDAR_EVENT_TYPE_ENUM["PAYMENT_DUE"] = "PAYMENT_DUE";
    CALENDAR_EVENT_TYPE_ENUM["INVOICE_GENERATED"] = "INVOICE_GENERATED";
    CALENDAR_EVENT_TYPE_ENUM["INVOICE_DUE"] = "INVOICE_DUE";
    CALENDAR_EVENT_TYPE_ENUM["SYSTEM_NOTIFICATION"] = "SYSTEM_NOTIFICATION";
    CALENDAR_EVENT_TYPE_ENUM["OTHER"] = "OTHER";
    CALENDAR_EVENT_TYPE_ENUM["GLOBAL"] = "GLOBAL";
    CALENDAR_EVENT_TYPE_ENUM["MAINTENANCE"] = "MAINTENANCE";
    CALENDAR_EVENT_TYPE_ENUM["OFFICE_CLOSURE"] = "OFFICE_CLOSURE";
    CALENDAR_EVENT_TYPE_ENUM["ANNOUNCEMENT"] = "ANNOUNCEMENT";
    CALENDAR_EVENT_TYPE_ENUM["TRAINING"] = "TRAINING";
    CALENDAR_EVENT_TYPE_ENUM["PAYDAY"] = "PAYDAY";
    CALENDAR_EVENT_TYPE_ENUM["GENERAL"] = "GENERAL";
